    ...
    return (
        <>
            <div className=" w-full px-5 md:px-20 pb-10">
                ...
                <div className="relative z-10 flex items-end justify-between pt-4 lg:pt-8 pb-6 border-b border-gray-200">
                ...
                <Tab.Group >
                    ...
                    <Tab.Panels className="border-4 border-dashed border-gray-200 p-4 rounded-lg mt-6" style={{height: '600px'}}>
