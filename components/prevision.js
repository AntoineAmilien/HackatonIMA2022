    ...
    return (
        <>
            ...
            <div className='flex row space-x-5 items-end'>
                ...
                <button className="btn btn-outline btn-primary btn" onClick={() => { console.log(validDate); setvalidDate(validDateInput) }}>provisionner</button>
            </div>
            ...
            {validDate ? <>            <div className='w-full flex justify-center mt-8'>
                <div className="stats ">
                    ...
                    <div className="stat">
                        ...
                        <div className="title-font font-medium sm:text-4xl text-3xl text-gray-900">124</div>
                    </div>

                    <div className="stat">
                        <div className="stat-title">Collaborateurs prévus</div>
                        <div className="title-font font-medium sm:text-4xl text-3xl text-gray-900">112</div>
                    </div>
